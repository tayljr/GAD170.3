Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/5a0951fecddb2ef409581f958f152bb7"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float2 st = frac(poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(1,1,0,0).xy * _Time.x) * (111.65 /*_GlitterFrequency*/);
